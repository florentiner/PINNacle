...
#
# Usage:
#   ./ns2d_longtime_parallel_run_mps.sh [N_WORKERS]
#   N_WORKERS defaults to auto: min(4, max(2, hw.physicalcpu / 2))
#   Override: MPS_N_WORKERS=2 ./ns2d_longtime_parallel_run_mps.sh
...
SCRIPT="experiments/optimization_multi_pde/ns2d_longtime_chain.py"
log_enable="true"
