...
def build_get_model(hidden_layers: str, datapath: str):
    def get_model():
        pde = Poisson2D_Classic(datapath=datapath)
...
def main():
    ...
    parser.add_argument("--name", type=str, default="poisson2d_classic_optuna")
    ...
    parser.add_argument("--results-csv", type=str, default="poisson2d_classic.csv")
    parser.add_argument("--study-name", type=str, default="poisson2d_classic_chain")
    parser.add_argument("--db-path", type=str, default="optuna_studies/poisson2d_classic.db")
    parser.add_argument("--datapath", type=str, default="ref/poisson1_cg_data.dat")
