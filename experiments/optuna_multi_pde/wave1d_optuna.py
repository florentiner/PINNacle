...
def main():
    ...
    parser.add_argument("--name", type=str, default="wave1d_optuna")
    ...
    parser.add_argument("--results-csv", type=str, default="wave1d.csv")
    parser.add_argument("--study-name", type=str, default="wave1d_chain")
    parser.add_argument("--db-path", type=str, default="optuna_studies/wave1d.db")
