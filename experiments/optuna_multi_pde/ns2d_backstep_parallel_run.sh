...
SCRIPT="experiments/optuna_multi_pde/ns2d_backstep_optuna.py"
DB_PATH="optuna_studies/ns2d_backstep.db"
STUDY_NAME="ns2d_backstep_chain"
N_TRIALS="${1:-500}"
N_PROCESSES="${2:-12}"
TIMEOUT_HOURS="${3:-48}"
VALUE_TYPE="${4:-fixed}"
...
echo "PDE: ns2d_backstep | Workers: $N_PROCESSES | value-type: $VALUE_TYPE | trials/worker: $N_TRIALS | timeout: ${{TIMEOUT_HOURS}}h"
