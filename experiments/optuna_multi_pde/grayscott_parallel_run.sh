...
SCRIPT="experiments/optuna_multi_pde/grayscott_optuna.py"
DB_PATH="optuna_studies/grayscott.db"
STUDY_NAME="grayscott_chain"
N_TRIALS="${1:-500}"
N_PROCESSES="${2:-12}"
TIMEOUT_HOURS="${3:-48}"
VALUE_TYPE="${4:-fixed}"
...
echo "PDE: grayscott | Workers: $N_PROCESSES | value-type: $VALUE_TYPE | trials/worker: $N_TRIALS | timeout: ${{TIMEOUT_HOURS}}h"
