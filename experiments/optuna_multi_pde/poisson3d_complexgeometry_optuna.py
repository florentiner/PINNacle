...
def main():
    ...
    parser.add_argument("--name", type=str, default="poisson3d_complexgeometry_optuna")
    ...
    parser.add_argument("--study-name", type=str, default="poisson3d_complexgeometry_chain")
    parser.add_argument("--db-path", type=str, default="optuna_studies/poisson3d_complexgeometry.db")
    ...
    parser.add_argument(
        ...
        default="tpe",
        choices=("tpe", "random"),
        help="Optuna sampler: 'tpe' (default) or 'random' baseline.",
    )
    parser.add_argument(
        "--sampler-seed",
        type=int,
