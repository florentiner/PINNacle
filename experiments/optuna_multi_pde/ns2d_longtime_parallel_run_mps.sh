...
#
# Usage:
#   ./ns2d_longtime_parallel_run_mps.sh [N_TRIALS_PER_WORKER] [N_WORKERS]
#   N_TRIALS_PER_WORKER defaults to 500. N_WORKERS defaults to auto (see below).
#   Override worker count: MPS_N_WORKERS=4 ./ns2d_longtime_parallel_run_mps.sh
#
...
STUDY_NAME="ns2d_longtime_chain"
N_TRIALS="${1:-500}"
