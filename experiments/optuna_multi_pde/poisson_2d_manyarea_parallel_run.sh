#!/bin/bash
# Automatic launch of poisson_2d_manyarea_optuna.py with GPU/MPS/CPU distribution

SCRIPT="experiments/optuna_multi_pde/poisson_2d_manyarea_optuna.py"
DB_PATH="optuna_studies/poisson_2d_manyarea.db"
STUDY_NAME="poisson_2d_manyarea_chain"
N_TRIALS="${1:-500}"
