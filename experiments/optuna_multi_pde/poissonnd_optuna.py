...
def build_get_model(hidden_layers: str, dim: int):
    def get_model():
        pde = PoissonND(dim=dim)
...
def main():
    ...
    parser.add_argument("--name", type=str, default="poissonnd_optuna")
    ...
    parser.add_argument("--results-csv", type=str, default="poissonnd.csv")
    parser.add_argument("--study-name", type=str, default="poissonnd_chain")
    parser.add_argument("--db-path", type=str, default="optuna_studies/poissonnd.db")
    parser.add_argument("--dim", type=int, default=5, help="Spatial dimension for PoissonND (default 5)")
    ...
    get_model = build_get_model(args.hidden_layers, args.dim)
