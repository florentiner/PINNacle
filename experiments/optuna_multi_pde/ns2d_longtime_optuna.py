...
proj_name = "rlpinn-ns2d-longtime-optuna"
experiment = start(
...
def main():
    ...
    parser.add_argument("--name", type=str, default="ns2d_longtime_optuna")
    ...
    parser.add_argument(
        "--results-csv",
        type=str,
        default="ns2d_longtime.csv",
        help="Written under PINNacle repo root (basename only).",
    )
    parser.add_argument("--study-name", type=str, default="ns2d_longtime_chain")
    parser.add_argument("--db-path", type=str, default="optuna_studies/ns2d_longtime.db")
