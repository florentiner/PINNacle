...
SCRIPT="experiments/optuna_multi_pde/wave1d_optuna.py"
DB_PATH="optuna_studies/wave1d.db"
STUDY_NAME="wave1d_chain"
N_TRIALS="${1:-500}"
N_PROCESSES="${2:-12}"
TIMEOUT_HOURS="${3:-48}"
VALUE_TYPE="${4:-fixed}"
...
echo "PDE: wave1d | Workers: $N_PROCESSES | value-type: $VALUE_TYPE | trials/worker: $N_TRIALS | timeout: ${{TIMEOUT_HOURS}}h"
