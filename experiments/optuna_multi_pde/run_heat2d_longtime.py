#!/usr/bin/env python3
"""
Evaluate best optimizer chains for heat2d_longtime (fixed + continuous).
...
Usage:
    python experiments/optuna_multi_pde/run_heat2d_longtime.py
...
# ── CONFIG ────────────────────────────────────────────────────────────────────
PDE_NAME      = "heat2d_longtime"
VALUE_TYPES   = ["fixed", "continuous"]   # run both
