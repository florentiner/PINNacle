...
def main():
    ...
    parser.add_argument("--name", type=str, default="heatnd_optuna")
    ...
    parser.add_argument("--results-csv", type=str, default="heatnd.csv")
    parser.add_argument("--study-name", type=str, default="heatnd_chain")
    parser.add_argument("--db-path", type=str, default="optuna_studies/heatnd.db")
    parser.add_argument("--dim", type=int, default=5, help="Spatial dimension for HeatND (default 5)")
