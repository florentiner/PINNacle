...
def build_get_model(hidden_layers: str, datapath: str):
    def get_model():
        pde = Heat2D_LongTime(datapath=datapath)
...
def main():
    ...
    parser.add_argument("--name", type=str, default="heat2d_longtime_optuna")
    ...
    parser.add_argument("--results-csv", type=str, default="heat2d_longtime.csv")
    parser.add_argument("--study-name", type=str, default="heat2d_longtime_chain")
    parser.add_argument("--db-path", type=str, default="optuna_studies/heat2d_longtime.db")
    parser.add_argument("--datapath", type=str, default="ref/heat_longtime.dat")
