#!/bin/bash
# Automatic launch of heatinv_optuna.py with GPU distribution via nvidia-smi
...
SCRIPT="experiments/optuna_multi_pde/heatinv_optuna.py"
DB_PATH="optuna_studies/heatinv.db"
STUDY_NAME="heatinv_chain_continues"
N_TRIALS="${1:-10}"  # per process; 8 processes => 8 * 8 = 64 total trials
N_PROCESSES="${2:-6}"  # Default to 8 processes, can be overridden
