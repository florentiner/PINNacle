...
def build_get_model(hidden_layers: str, datapath: str):
    def get_model():
        pde = GrayScottEquation(datapath=datapath)
...
def main():
    ...
    parser.add_argument("--name", type=str, default="grayscott_optuna")
    ...
    parser.add_argument("--results-csv", type=str, default="grayscott.csv")
    parser.add_argument("--study-name", type=str, default="grayscott_chain")
    parser.add_argument("--db-path", type=str, default="optuna_studies/grayscott.db")
    parser.add_argument("--datapath", type=str, default="ref/grayscott.dat")
