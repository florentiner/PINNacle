...
SCRIPT="experiments/optuna_multi_pde/wave2d_heterogeneous_optuna.py"
DB_PATH="optuna_studies/wave2d_heterogeneous.db"
STUDY_NAME="wave2d_heterogeneous_chain"
N_TRIALS="${1:-500}"
N_PROCESSES="${2:-12}"
TIMEOUT_HOURS="${3:-48}"
VALUE_TYPE="${4:-fixed}"
...
echo "PDE: wave2d_heterogeneous | Workers: $N_PROCESSES | value-type: $VALUE_TYPE | trials/worker: $N_TRIALS | timeout: ${{TIMEOUT_HOURS}}h"
