...
def build_get_model(hidden_layers: str, datapath: str):
    def get_model():
        pde = PoissonBoltzmann2D(datapath=datapath)
...
def main():
    ...
    parser.add_argument("--name", type=str, default="poissonboltzmann2d_optuna")
    ...
    parser.add_argument("--results-csv", type=str, default="poissonboltzmann2d.csv")
    parser.add_argument("--study-name", type=str, default="poissonboltzmann2d_chain")
    parser.add_argument("--db-path", type=str, default="optuna_studies/poissonboltzmann2d.db")
    parser.add_argument("--datapath", type=str, default="ref/poisson_boltzmann2d.dat")
