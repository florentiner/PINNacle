...
SCRIPT="experiments/optuna_multi_pde/poisson2d_classic_optuna.py"
DB_PATH="optuna_studies/poisson2d_classic.db"
STUDY_NAME="poisson2d_classic_chain"
N_TRIALS="${1:-500}"
N_PROCESSES="${2:-12}"
TIMEOUT_HOURS="${3:-48}"
VALUE_TYPE="${4:-fixed}"
...
echo "PDE: poisson2d_classic | Workers: $N_PROCESSES | value-type: $VALUE_TYPE | trials/worker: $N_TRIALS | timeout: ${{TIMEOUT_HOURS}}h"
