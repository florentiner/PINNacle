...
proj_name = "rlpinn-kuramoto-sivashinsky-optuna"
experiment = start(
...
def main():
    ...
    parser.add_argument("--name", type=str, default="kuramoto_sivashinsky_optuna")
    ...
    parser.add_argument(
        "--results-csv",
        type=str,
        default="kuramoto_sivashinsky.csv",
        help="Written under PINNacle repo root (basename only).",
    )
    parser.add_argument("--study-name", type=str, default="kuramoto_sivashinsky_chain")
    parser.add_argument("--db-path", type=str, default="optuna_studies/kuramoto_sivashinsky.db")
