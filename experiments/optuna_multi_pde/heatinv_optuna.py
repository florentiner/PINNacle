...
proj_name = "rlpinn-heatinv-optuna"
experiment = start(
...
def main():
    ...
    parser.add_argument("--name", type=str, default="heatinv_optuna")
    ...
    parser.add_argument("--study-name", type=str, default="heatinv_chain")
    parser.add_argument("--db-path", type=str, default="optuna_studies/heatinv.db")
