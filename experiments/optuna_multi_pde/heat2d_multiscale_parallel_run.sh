...
SCRIPT="experiments/optuna_multi_pde/heat2d_multiscale_optuna.py"
DB_PATH="optuna_studies/heat2d_multiscale.db"
STUDY_NAME="heat2d_multiscale_chain"
N_TRIALS="${1:-500}"
N_PROCESSES="${2:-12}"
TIMEOUT_HOURS="${3:-48}"
VALUE_TYPE="${4:-fixed}"
...
echo "PDE: heat2d_multiscale | Workers: $N_PROCESSES | value-type: $VALUE_TYPE | trials/worker: $N_TRIALS | timeout: ${{TIMEOUT_HOURS}}h"
