...
def build_get_model(hidden_layers: str, datapath: str):
    def get_model():
        pde = Heat2D_VaryingCoef(datapath=datapath)
...
def main():
    ...
    parser.add_argument("--name", type=str, default="heat2d_varyingcoef_optuna")
    ...
    parser.add_argument("--results-csv", type=str, default="heat2d_varyingcoef.csv")
    parser.add_argument("--study-name", type=str, default="heat2d_varyingcoef_chain")
    parser.add_argument("--db-path", type=str, default="optuna_studies/heat2d_varyingcoef.db")
    parser.add_argument("--datapath", type=str, default="ref/heat_darcy.dat")
