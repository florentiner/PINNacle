...
def build_get_model(hidden_layers: str, datapath: str, icpath_u: str, icpath_v: str):
    def get_model():
        pde = Burgers2D(datapath=datapath, icpath=(icpath_u, icpath_v))
...
def main():
    ...
    parser.add_argument("--name", type=str, default="burgers_2d_optuna")
    ...
    parser.add_argument("--results-csv", type=str, default="burgers_2d.csv")
    parser.add_argument("--study-name", type=str, default="burgers_2d_chain")
    parser.add_argument("--db-path", type=str, default="optuna_studies/burgers_2d.db")
    parser.add_argument("--datapath", type=str, default="ref/burgers2d_0.dat")
    parser.add_argument("--icpath-u", type=str, default="ref/burgers2d_init_u_0.dat")
    parser.add_argument("--icpath-v", type=str, default="ref/burgers2d_init_v_0.dat")
    ...
    get_model = build_get_model(args.hidden_layers, args.datapath, args.icpath_u, args.icpath_v)
