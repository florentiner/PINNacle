...
def build_get_model(hidden_layers: str, datapath: str):
    def get_model():
        pde = NS2D_BackStep(datapath=datapath)
...
def main():
    ...
    parser.add_argument("--name", type=str, default="ns2d_backstep_optuna")
    ...
    parser.add_argument("--results-csv", type=str, default="ns2d_backstep.csv")
    parser.add_argument("--study-name", type=str, default="ns2d_backstep_chain")
    parser.add_argument("--db-path", type=str, default="optuna_studies/ns2d_backstep.db")
    parser.add_argument("--datapath", type=str, default="ref/ns_0_obstacle.dat")
