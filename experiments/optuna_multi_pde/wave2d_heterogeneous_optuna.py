...
def build_get_model(hidden_layers: str, datapath: str):
    def get_model():
        pde = Wave2D_Heterogeneous(datapath=datapath)
...
def main():
    ...
    parser.add_argument("--name", type=str, default="wave2d_heterogeneous_optuna")
    ...
    parser.add_argument("--results-csv", type=str, default="wave2d_heterogeneous.csv")
    parser.add_argument("--study-name", type=str, default="wave2d_heterogeneous_chain")
    parser.add_argument("--db-path", type=str, default="optuna_studies/wave2d_heterogeneous.db")
    parser.add_argument("--datapath", type=str, default="ref/wave_darcy.dat")
