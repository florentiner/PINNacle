#!/bin/bash
# Automatic launch of poisson_boltzmann_2d_optuna.py with GPU/MPS/CPU distribution

SCRIPT="experiments/optuna_multi_pde/poisson_boltzmann_2d_optuna.py"
DB_PATH="optuna_studies/poisson_boltzmann_2d.db"
STUDY_NAME="poisson_boltzmann_2d_chain"
N_TRIALS="${1:-500}"
