#!/bin/bash
# Automatic launch of wave_1d_optuna.py with GPU/MPS/CPU distribution

SCRIPT="experiments/optuna_multi_pde/wave_1d_optuna.py"
DB_PATH="optuna_studies/wave_1d.db"
STUDY_NAME="wave_1d_chain"
N_TRIALS="${1:-500}"
