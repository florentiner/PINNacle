...
def main():
    ...
    parser.add_argument("--name", type=str, default="poissoninv_optuna")
    ...
    parser.add_argument("--results-csv", type=str, default="poissoninv.csv")
    parser.add_argument("--study-name", type=str, default="poissoninv_chain")
    parser.add_argument("--db-path", type=str, default="optuna_studies/poissoninv.db")
