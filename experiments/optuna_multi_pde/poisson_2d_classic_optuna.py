...
proj_name = "rlpinn-poisson-2d-classic-optuna"
experiment = start(
...
def main():
    ...
    parser.add_argument(
        "--results-csv",
        type=str,
        default="poisson_2d_classic.csv",
        help="Written under PINNacle repo root (basename only).",
    )
    parser.add_argument("--study-name", type=str, default="poisson_2d_classic_chain")
    parser.add_argument("--db-path", type=str, default="optuna_studies/poisson_2d_classic.db")
