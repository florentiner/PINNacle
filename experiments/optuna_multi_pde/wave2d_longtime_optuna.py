...
def main():
    ...
    parser.add_argument("--name", type=str, default="wave2d_longtime_optuna")
    ...
    parser.add_argument("--results-csv", type=str, default="wave2d_longtime.csv")
    parser.add_argument("--study-name", type=str, default="wave2d_longtime_chain")
    parser.add_argument("--db-path", type=str, default="optuna_studies/wave2d_longtime.db")
