...
proj_name = "rlpinn-wave-1d-optuna"
experiment = start(
...
def main():
    ...
    parser.add_argument("--study-name", type=str, default="wave_1d_chain")
    parser.add_argument("--db-path", type=str, default="optuna_studies/wave_1d.db")
