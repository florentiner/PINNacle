...
def main():
    ...
    parser.add_argument("--name", type=str, default="heat2d_multiscale_optuna")
    ...
    parser.add_argument("--results-csv", type=str, default="heat2d_multiscale.csv")
    parser.add_argument("--study-name", type=str, default="heat2d_multiscale_chain")
    parser.add_argument("--db-path", type=str, default="optuna_studies/heat2d_multiscale.db")
